package com.breezefieldkrishnatea.features.contacts
...
import com.breezefieldkrishnatea.MobileContact
...
import com.breezefieldkrishnatea.app.domain.CallHisEntity
import com.breezefieldkrishnatea.app.domain.CompanyMasterEntity
import com.breezefieldkrishnatea.app.domain.ContactActivityEntity
import com.breezefieldkrishnatea.app.domain.ShopActivityEntity
...
import com.breezefieldkrishnatea.features.nearbyshops.presentation.AdapterCallLogL
import com.breezefieldkrishnatea.features.nearbyshops.presentation.ShopAddressUpdateListener
import com.breezefieldkrishnatea.features.nearbyshops.presentation.UpdateShopAddressDialog
import com.breezefieldkrishnatea.features.nearbyshops.presentation.UpdateShopStatusDialog
        ...
        doAsync {
            ...
            uiThread {
                ...
                if(contactL.size>0){
                    ...
                    Handler().postDelayed(Runnable {
                        //Toaster.msgShort(mContext,"No contact is pending for sync!")
        ...
        if(contL.size>0){
            ...
            adapterContactList = AdapterContactList(mContext,contL,et_search.text.toString(),object :AdapterContactList.onClick{
                ...
                override fun onWhatsClick(obj: AddShopDBModelEntity) {
                    ...
                    if (obj.whatsappNoForCustomer != null || obj.whatsappNoForCustomer == "") {
                        val url =
...
//end AppV 4.2.2 tufan    20/09/2023 FSSAI Lic No Implementation 26813
    ...
    fun generateContactDtlsPdf(shopObj:AddShopDBModelEntity){
        ...
        try{
            ...
            try {
                val whatsNo = Paragraph("Whatsapp No.              :      " + shopObj?.whatsappNoForCustomer, font1)
