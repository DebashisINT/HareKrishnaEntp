package com.breezefieldkrishnatea.features.leaderboard
...
import com.breezefieldkrishnatea.features.contacts.AdapterScheduleContactName
import com.breezefieldkrishnatea.features.contacts.CustomData
import com.breezefieldkrishnatea.features.contacts.GenericDialog
import com.breezefieldkrishnatea.features.contacts.GenericDialogWithOutSearch
import com.breezefieldkrishnatea.features.contacts.ScheduleContactDtls
import com.breezefieldkrishnatea.features.dashboard.presentation.DashboardActivity
import com.breezefieldkrishnatea.features.leaderboard.api.BranchData
import com.breezefieldkrishnatea.features.leaderboard.api.LeaderboardBranchData
import com.breezefieldkrishnatea.features.leaderboard.api.LeaderboardRepoProvider
import com.breezefieldkrishnatea.features.leaderboard.api.SubBranchData
...
import kotlinx.android.synthetic.main.dialog_leaderboard_subbranch_select.cb_dialog_subBranch_select_all
...
class LeaderBoardFrag : BaseFragment(), View.OnClickListener{
        ...
        when(v?.id){
            ...
            R.id.bt_own ->{
                ...
                Glide.with(mContext)
                    ...
                    .apply(RequestOptions.placeholderOf(R.drawable.baseline_account_circle_24).error(R.drawable.baseline_account_circle_24))
                    .into(iv_ownimg)
                if (!str_filterSubBranchID.equals("")) {
                    ownAPI()
                    iv_empty_data.visibility = View.INVISIBLE
            ...
            repository.overAllAPI(Pref.user_id!!,"All",str_filterSubBranchID,flag)
                ...
                .subscribe({ result ->
                    ...
                    if(result.status == NetworkConstant.SUCCESS){
                        ...
                        val firstToThirdRank = mLeaderBoardData.filter { it.position in 1..3 }
                        val fourthToTenthRank = mLeaderBoardData.filter { it.position > 3 }
                        println("firstToThirdRank_tag"+firstToThirdRank)
                        println("fourthToTenthRank_tag"+fourthToTenthRank)
                        mLeaderBoardAdapter = LeaderBoardAdapter(mLeaderBoardData,mContext)
                    ...
                    Handler().postDelayed(Runnable {
                        if (result.status == NetworkConstant.SUCCESS) {
                            ...
                            Glide.with(mContext)
                                ...
                                .apply(
                                    RequestOptions.placeholderOf(R.drawable.baseline_account_circle_24)
                                        .error(R.drawable.baseline_account_circle_24)
                                )
                                .into(iv_ownimg)
                            if (result.position.equals("1")) {
                                iv_OwnTag.visibility = View.VISIBLE
                                iv_OwnTag.setBackgroundResource(R.drawable.first_icon);
                            } else if (result.position.equals("2")) {
                                iv_OwnTag.visibility = View.VISIBLE
                                iv_OwnTag.setBackgroundResource(R.drawable.second_icon)
                            } else if (result.position.equals("3")) {
                                iv_OwnTag.visibility = View.VISIBLE
                            ...
                            if (result.status.equals("205")) {
                                ...
                                tv_nodata.visibility = View.VISIBLE
                                tv_nodata.visibility = View.VISIBLE
                                iv_ownimg2.visibility =View.INVISIBLE
                                tv_ownscore.visibility =View.INVISIBLE
                                tv_ownrank.visibility =View.INVISIBLE
                ...
                repository.branchlist(Pref.session_token.toString())
                    ...
                    .subscribe({ result ->
                         ...
                         if (respBranchData.branch_list.size > 0) {
                             ...
                             str_filterBranchID =
                                 respBranchData.branch_list.get(0).branch_head_id.toString()
    ...
    private fun getSubBranchList(tv_subBranch: TextView, subBranch_list: ArrayList<SubBranchData>) {
       /* var genericL : ArrayList<CustomData> = ArrayList()
        ...
        subBranchDialog.setCancelable(true)
       ...
       // val submit = subBranchDialog.findViewById(R.id.tv_dialog_cont_list_submit) as TextView
